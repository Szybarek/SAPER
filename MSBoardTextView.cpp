...
//konstruktor
MSBoardTextView::MSBoardTextView(MinesweeperBoard& start) : displayableBoard(start)
{
    height = start.getBoardHeight();
    width = start.getBoardWidth();
    state = start.getGameState();
}
